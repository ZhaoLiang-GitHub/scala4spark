...
import com.xm.sdalg.commons.ClusterUtils.{locale2locale, localeInCluster, singapore}
    ...
    def main(args: Array[String]): Unit = {
        ...
        val front7DaysNoRecall = noRecallSetRdd
            ...
            .map(row => {
                ...
                val id = Array(temp(0), "last7day", temp(1), temp(2), "V9").mkString("_")
        ...
        rddSaveInHDFS(sparkSession, resultDf.toJSON.rdd, dim_appstore_recommend_tag_doc(endDate, locale2locale(lo), "7DaysNoRecallCateV9"))
