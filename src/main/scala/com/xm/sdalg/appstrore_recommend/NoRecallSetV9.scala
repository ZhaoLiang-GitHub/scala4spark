...
object NoRecallSetV9 {
    def main(args: Array[String]): Unit = {
        ...
        val front7DaysNoRecall = noRecallSetRdd
            .groupByKey()
            .map(row => {
                val id = Array(row._1.split("_")(0), "last7day", row._1.split("_")(1), "V9").mkString("_")
        ...
        rddSaveInHDFS(sparkSession, resultDf.toJSON.rdd, dim_appstore_recommend_tag_doc(endDate, locale2locale(lo), "7DaysNoRecallSetV9"))
